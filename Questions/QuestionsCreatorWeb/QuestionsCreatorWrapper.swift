...
"""
		...
		<h4>Options <button id="options-button" type="button" class="btn btn-primary btn-sm rounded-button"> + </button></h4>
		<section id="options-content" style="display: none">
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text" id="inputGroup-sizing-default">Name</span>
				</div>
				<input id="topic-name" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" placeholder="(Optional but recommended)">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text" id="inputGroup-sizing-default">Time per set (s)</span>
				</div>
				<input id="topic-time" type="tel" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" placeholder="(Optional)">
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text">Questions in random order</span>
					<span class="input-group-text">
						<input id="topic-random-order" type="checkbox" aria-label="Checkbox for following text input" checked>
					</span>
				</div>
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					...
					<span class="input-group-text">
						<input id="topic-help-button" type="checkbox" aria-label="Checkbox for following text input" checked>
					</span>
				</div>
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					...
					<span class="input-group-text">
						<input id="topic-correct-answer" type="checkbox" aria-label="Checkbox for following text input" checked>
					</span>
				</div>
			</div>
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					...
					<span class="input-group-text">
						<input id="topic-force-choose" type="checkbox" aria-label="Checkbox for following text input">
					</span>
				</div>
			</div>
		</section>
...
"""
		...
		for i in 1...self.numberOfSets {
			...
			<h4><button id="topic-\(i)-button" type="button" class="btn btn-primary btn-sm rounded-button" style="margin-right: 6pt"> + </button>Topic \(i) </h4>
			...
			for j in 1...self.questionsPerSet {
				...
				<section id="full-question-\(i)-\(j)" style="margin-top: 10pt; margin-left: 6pt">
				    <h4><button id="question-\(i)-\(j)-button" type="button" class="btn btn-primary btn-sm rounded-button" style="margin-right: 6pt"> + </button>Question \(j)</h4>
					<section id="question-\(i)-\(j)-content" style="display: none; margin-top: 10pt">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text">Question</span>
							</div>
							<textarea id="question-text-\(i)-\(j)" class="form-control" aria-label="With textarea"></textarea>
						</div>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
								<span class="input-group-text" id="inputGroup-sizing-default">Image URL</span>
							</div>
							<input id="question-image-\(i)-\(j)" type="url" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" placeholder="(Optional)">
						</div>
				...
				for k in 1...self.answersPerQuestion {
					...
					<div class="input-group mb-3">
						<div class="input-group-prepend">
							...
							<span class="input-group-text"><input id="answer-correct-\(i)-\(j)-\(k)" type="checkbox" aria-label="Checkbox for following text input"></span>
						</div>
						<input id="answer-\(i)-\(j)-\(k)" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>
					</div>
					"""
				}
